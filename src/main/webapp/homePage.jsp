    ...
    <main class="bg-hero-img shadow">
        ...
        <div class="container-home-page">
            <div class="text-white d-flex flex-column align-items-center">
                ...
                <p class="fs-5">Aqui você pode apostar nos melhores robôs do NEXT</p>
            </div>
        </div>

    </main>

    <footer class=" footer bg-grey d-flex flex-column justify-content-center align-items-center p-5">
        ...
        <div class="row justify-content-evenly w-100 text-center fs-5">
            ...
            <div class="col-2">
                <a  class="link-nomes" href="https://github.com/DerickPederzini">Derick Pederzini</a>
            </div>

            <div class="col-2">
                <a target="_blank" class="link-nomes" href="https://github.com/KinderEnge">Felipe Enge</a>
            </div>

            <div class="col-2">
                <a target="_blank" class="link-nomes" href="https://github.com/dev-earaujo">Eduardo Araújo</a>
            </div>

            <div class="col-2">
                <a target="_blank" class="link-nomes" href="https://github.com/marcelo-neuro">Marcelo Furlanetto</a>
            </div>
            
            <div class="col-2">
                <a target="_blank" class="link-nomes" href="https://github.com/NicolasVPagliari">Nicolas Pagliari</a>
            </div>
        </div>
    </footer>
